...
const IconTeacher = ({ size = 14, className = "" }) => (<svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>);
    ...
    <TeacherLayout title="طلبات الاشتراك">
      ...
      <div className="header-container">
        <div>
            ...
            <p className="sub-header">متابعة وإدارة الاشتراكات الخاصة بكورساتك والموافقة عليها</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="empty-state">
            ...
            <p>جرب تغيير الفلتر للاطلاع على طلبات أخرى.</p>
        </div>
      ) : (
        <>
            ...
            {requests.map(req => {
                ...
                // ✅ التحقق من وجود سعر فعلي مدفوع (للعرض فقط، لا يملك المدرس صلاحية التعديل)
                const hasActualPrice = req.actual_paid_price !== null && req.actual_paid_price !== undefined && req.actual_paid_price < req.total_price;
                ...
                return (
                    <div key={req.id} className={`request-card ${req.status}`}>
                        ...
                        <div className="card-body">
                            ...
                            {/* ✅ قسم عرض السعر (الأصلي + المخصوم إن وُجد) */}
